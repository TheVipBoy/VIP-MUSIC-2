...
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "THE VIP BOY")
...
BOT_NAME = getenv("BOT_NAME", " VIP MUSIC PLAYER")
BOT_TOKEN = getenv("BOT_TOKEN", "")
BOT_USERNAME = getenv("BOT_USERNAME", "TG_MUSIC_ROBOT")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "1200"))
OWNER_NAME = getenv("OWNER_NAME", "THE VIP BOY")
